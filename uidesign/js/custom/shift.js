        ...
        success: function(result) {
            $.each(result[0], function (i) {
                ...
                $.each(result[1], function (g) {
                    if(result[1][g].id == result[0][i].shift_code_id)str += '<option value="'+ result[1][g].id +'" selected>'+result[1][g].shift_code+'</option>';
                    else str += '<option value="'+ result[1][g].id +'">'+result[1][g].shift_code+'</option>';
