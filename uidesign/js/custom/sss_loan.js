...
$(document).ready(function(){
    ...
    $(document).on('click', '.edit_sss', function(){
        ...
        let sss_loan_date = $(this).attr('sss_loan_date');
        let loan_amount = $(this).attr('loan_amount');
        let sss_loan_id = $(this).attr('sss_loan_id');
        ...
        $('#sss_loan_date_2').val(sss_loan_date);
        $('#loan_amount_2').val(loan_amount);
        $('#sss_loan_id').val(sss_loan_id);
        ...
        if(sss_loan_id){
           ...
           $('#deduction_list').DataTable().clear().draw();
            ...
            $.ajax({
                url: url,
                type: 'POST',
                data: {sss_loan_id:sss_loan_id, type:'sss'},
                headers: {
    ...
    $(document).on('click', '.add_deduction', function(){
        ...
        $('#emp_sss_loan_id').val(sss_loan_id);
