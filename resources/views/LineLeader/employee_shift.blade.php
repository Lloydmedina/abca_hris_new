...
@endsection
{{-- END PAGE LEVEL CSS --}}
@section('title','Employee Shift Setup')
{{-- BEGIN CONTENT --}}
@section('content')
<!-- Begin Page Content -->
      ...
      <div class="col-4">
         <div class="card">
            <div class="card-body">
               <div class="row">
                  <div class="col-6">
                     <h4 class="card-title">First List</h4>
                  </div>
               </div>
               
               <div class="table-responsive m-t-40">
                  <table id="first_shift" class="display nowrap table table-sm table-hover table-striped table-bordered" cellspacing="0" width="100%">
                     <thead>
                        <tr>
      ...
      <div class="col-4">
         <div class="card">
            <div class="card-body">
               <div class="row">
                  <div class="col-6">
                     <h4 class="card-title">Second List</h4>
                  </div>
      ...
      <div class="col-4">
         <div class="card">
            <div class="card-body">
               <div class="row">
                  <div class="col-6">
                     <h4 class="card-title">Third List</h4>
                  </div>
                  <div class="col-6 text-right">
                     <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#entry_modal"><i class="fa fa-plus-circle"></i> Add New</button>
                  </div>
