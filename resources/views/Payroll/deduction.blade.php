...
<div class="container-fluid">
   ...
   <div class="card">
      <div class="card-body">
            <form action="{{ url('/deduction') }}" method="get">
               <div class="row">
      ...
      <div class="card-body">
         <div class="row">
            <div class="col-lg-4 col-sm-12">
               <h4 class="card-title">List of Deductions</h4>
            </div>
            <div class="col-lg-4 col-sm-12">
                     ...
                     @foreach($list as $row)
                        <tr id="{{ $row->payroll_other_id.md5($row->payroll_other_id) }}">
                           ...
                           <td class="text-center">
                              <span class="text-dark update_deduction" style="cursor: pointer;"
                           ...
                           <td class="text-center">
                              <a href="javascript:(0)" data-id="{{ $row->payroll_other_id.md5($row->payroll_other_id) }}" class="ml-1 text-danger deleteatd_" title="Delete Deduction">
            ...
            <div class="modal-body">
               <div class="form-body">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           <label class="control-label">Deduction <i class="text-small text-danger">*</i></label>
                           <input type="number" name="deduction"  class="form-control" step="any" required>
                           <input type="text" name="service_type" value="deduction" hidden>
                        </div>
                     </div>
                  </div>
                  <div class="row">
               ...
               <div class="form-body">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           <label class="control-label">Deduction <i class="text-small text-danger">*</i></label>
                           <input type="number" id="update_deduction" name="deduction"  class="form-control" step="any" required>
                           <input type="text" name="service_type" value="deduction" hidden>
                        </div>
                     </div>
                  </div>
...
<script>
   $(document).ready(function(){
      ...
      $(document).on('click', '.update_deduction', function(e) {
         ...
         $('#update_deduction').val(deduction);
