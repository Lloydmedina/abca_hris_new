      ...
      <div class="card-body">
         <div class="row">
            <div class="col-lg-4 col-sm-12">
               <h4 class="card-title">List of Other Income</h4>
            </div>
            <div class="col-lg-4 col-sm-12">
                     ...
                     @foreach($list as $row)
                        <tr id="{{ $row->payroll_other_id.md5($row->payroll_other_id) }}">
                           ...
                           <td class="text-center">
                              <span class="text-dark update_other_income" style="cursor: pointer;"
                              ...
                              data-other_income="{{ $row->other_income }}"
   ...
   <div class="modal-dialog modal-md">
      <div class="modal-content">
         <div class="modal-header bg-primary text-white">
            <h4 class="modal-title">Other Income</h4>
            ...
            <div class="modal-body">
               <div class="form-body">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           <label class="control-label">Other Income <i class="text-small text-danger">*</i></label>
                           <input type="number" name="other_income" class="form-control" step="any" required>
                           <input type="text" name="service_type" value="other_income" hidden>
                        </div>
                     </div>
                  </div>
                  <div class="row">
...
<div id="update_modal" class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="myModalLabelAdd" style=" padding-right: 17px;">
   <div class="modal-dialog modal-md">
      <div class="modal-content">
         <div class="modal-header bg-primary text-white">
            <h4 class="modal-title">Update Other Income</h4>
            <button type="button" class="close text-danger" data-dismiss="modal" aria-hidden="true" title="Close">×</button>
         </div>
               ...
               <div class="form-body">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           <label class="control-label">Other Income <i class="text-small text-danger">*</i></label>
                           <input type="number" id="update_other_income" name="other_income" class="form-control" step="any" required>
                           <input type="text" name="service_type" value="other_income" hidden>
                        </div>
                     </div>
                  </div>
