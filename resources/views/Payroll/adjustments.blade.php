...
<div class="container-fluid">
   ...
   <div class="card">
      <div class="card-body">
            <form action="{{ url('/adjustments') }}" method="get">
               <div class="row">
                     ...
                     @foreach($list as $row)
                        <tr id="{{ $row->payroll_other_id.md5($row->payroll_other_id) }}">
                           ...
                           <td class="text-center">
                              <span class="text-dark update_adjustments" style="cursor: pointer;"
                              ...
                              data-adjustments="{{ $row->adjustments }}"
            ...
            <div class="modal-body">
               <div class="form-body">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           <label class="control-label">Adjustment <i class="text-small text-danger">*</i></label>
                           <input type="number" name="adjustments"  class="form-control" step="any" required>
                           <input type="text" name="service_type" value="adjustments" hidden>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input type="number" id="update_adjustments" name="adjustments"  class="form-control" step="any" required>
                           <input type="text" name="service_type" value="adjustments" hidden>
                        </div>
                     </div>
                  </div>
