...
<div class="container-fluid" style="min-height: 550px">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="file_overtime_request" action="{{ route('file_overtime_request') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <div class="text-center">
                            <button type="button" id="sub_btn_save_overtime" class="btn btn-dark mt-0 mb-2"><i class="fa-solid fa-floppy-disk"></i> Save</button>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#file_overtime_request").submit(function(e){
            e.preventDefault();
            Swal.fire({
                title: "Would you like to submit your overtime?",
                ...
                if (result.value) {
                    ...
                    Swal.fire({
                        ...
                        $("#file_overtime_request").unbind('submit').submit();
                    });
