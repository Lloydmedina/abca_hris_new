...
<div class="container-fluid" style="min-height: 550px">
    ...
    <div class="card">
        <div class="card-body">
            <form id="file_undertime_request" action="{{ route('file_undertime_request') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="total_time" name="total_time" value="{{ old('total_time') }}" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-12"></div>
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <div class="text-center">
                            <button type="button" id="sub_btn_save_undertime" class="btn btn-dark mt-0 mb-2"><i class="fa-solid fa-floppy-disk"></i> Save</button>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#file_undertime_request").submit(function(e){
            e.preventDefault();
            Swal.fire({
                title: "Would you like to submit your undertime?",
                ...
                if (result.value) {
                    ...
                    Swal.fire({
                        ...
                        $("#file_undertime_request").unbind('submit').submit();
                    });
