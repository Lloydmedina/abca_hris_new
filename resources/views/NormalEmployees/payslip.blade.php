                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-right" id="payPeriod">
                                                        PAYROLL PERIOD: {{ date('M d, Y', strtotime($row->date_from)) }} -
                                            ...
                                            <div style="border: 2px solid; border-radius: 5px;">
                                                <div class="row p-t-20" style="padding: 1%;">
                                                    ...
                                                    <div class="col-md-2">
                                                        <p><b>Bi-Monthly Rate</b></p>
                                                        <p id="basicPay">{{ number_format($row->basic_pay, 2) }}</p>
                                                    </div>
                                                </div>
                                                <div class="row p-t-20" style="padding: 1%;">
                                                    <div class="col-md-6">
                                                        <p><b>EMP Department / Section</b></p>
                                                        ...
                                                        <div class="table-responsive m-t-40">
                                                            <table class="display nowrap table table-sm table-hover"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @endif
                                                                    @if ($row->communication_allowance != 0)
                                                                        <tr id="tr_Communication_Allowance">
                                                                            <td>Mobile Allowance</td>
                                                                            <td class="text-right align-middle"
                                                                                id="communication_allowance">
                                                                                {{ number_format($row->communication_allowance, 2) }}
                                                                            </td>
                                                                        </tr>
                                                                    @endif
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right align-middle"
                                                                            id="totalNonTaxable">
                                                                            @if ($row->adjustments > 0)
                                                                                {{ number_format($row->adjustments + $row->HousingAllowance + $row->Allowance + $row->ReimbursementFee + $row->TransportationAllowance + $row->communication_allowance + $row->rice_allowance, 2) }}

                                                                            @else
                                                                                {{ number_format($row->HousingAllowance + $row->Allowance + $row->ReimbursementFee + $row->TransportationAllowance +$row->communication_allowance + $row->rice_allowance, 2) }}
                                                        ...
                                                        <div class="table-responsive m-t-40">
                                                            <table class="display nowrap table table-sm table-hover"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @if ($row->adjustments < 0)
                                                                        <tr id="tr_adjustments">
                                                                            <td><b>Salary Adjustment(-)<b></td>
                                                                            <td class="text-right align-middle"
                                                                                id="mealAllowance">
                                                                                {{ number_format(abs($row->adjustments), 2) }}
                                                                            </td>
                                                                        </tr>
                                                                    @endif
                                                                    @if ($row->ATD != 0)
                                                                        <tr>
                                                                            <td><b>ATD</b> ({{ $row->atdremarks }}) </td>
                                                                            <td class="text-right align-middle"
                                                                                id="atd">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right align-middle"
                                                                            id="totalDeduction">
                                                                            @if ($row->adjustments < 0)
                                                                                {{ number_format(abs($row->adjustments) + $row->UTDeduction + $row->VLWithOutPayDeduction + $row->SLWithOutPayDeduction + $row->MOORGATE_Loan + $row->other_deductions + $row->pagibig_loan + $row->sss_loan + $row->late_deduction + $row->sss + $row->ssswisp + $row->philhealth + $row->pag_ibig + $row->wtax + $row->cash_advance + $row->ATD, 2) }}
