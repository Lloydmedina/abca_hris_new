...
@endsection
{{-- END PAGE LEVEL CSS --}}
@section('title','Employee Shift Schedule Setup')
{{-- BEGIN CONTENT --}}
@section('content')
<!-- Begin Page Content -->
<div class="container-fluid">
   ...
   <div class="card">
      <div class="card-body">
         <div class="row">
            <div class="col-6">
               <h4 class="card-title">Employee Shift Schedule</h4>
            </div>
            ...
            <table id="example23" class="display nowrap table table-sm table-hover table-striped table-bordered" cellspacing="0" width="100%">
               <thead>
                  <tr>
                     ...
                     <th class="text-center" colspan="4">Schedule</th>
                  ...
                  <div class="row p-t-20">
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" id="cost_center_code" name="cost_center_code" class="form-control" required>
                        </div>
                     </div>
                     <!--/span-->
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input class="form-control text-right" type="number" id="balance" name="balance">
                        </div>
                     </div>
                     <!--/span-->
                  </div>
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group has-danger">
                           ...
                           <input type="text" id="cost_center" name="cost_center"  class="form-control" required>
                        </div>
                     </div>
                  </div>
                  <div class="row">
