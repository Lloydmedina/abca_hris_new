...
@endsection
{{-- END PAGE LEVEL CSS --}}
@section('title','PAG-IBIG Loan Setup')
{{-- BEGIN CONTENT --}}
@section('content')
<!-- Begin Page Content -->
<div class="container-fluid">
   ...
   <div class="card">
      <div class="card-body">
         <div class="row">
            <div class="col-6">
               <h4 class="card-title">PAG-IBIG Loan Setup</h4>
            </div>
         ...
         <div class="table-responsive m-t-40">
            <table id="loan_list" class="display nowrap table table-sm table-hover table-striped table-bordered" cellspacing="0" width="100%">
               <thead>
                  <tr>
                     <th class="">Seq #</th>
                     <th class="">Date</th>
                  ...
                  @if(count($loan) > 0)
                     ...
                     @foreach($loan as $row)
                        <tr>
                           ...
                           <td class="">
                              {{ date('M d, Y',strtotime($row->pagibig_loan_date)) }}
                           </td>
                           <td class="">
                              {{ $row->emp_name }}
                           </td>
                           ...
                           <td class="text-center">
                              <a href="javascript::(0)" class="view_deduction" employee="{{ $row->emp_name }}" pagibig_loan_id="{{ $row->pagibig_loan_id }}" data-toggle="modal" data-target="#view_deduction_pagibig_loan">
                                 <span class="fa fa-info"></span> View
                              </a>
                              |
                              <a href="javascript::(0)" class="add_deduction" employee="{{ $row->emp_name }}" pagibig_loan_id="{{ $row->pagibig_loan_id }}" data-toggle="modal" data-target="#add_deduction_pagibig_loan">
                           ...
                           <td class="text-center">
                              <div class="w-100">
                                 <a href="#!" class="edit_pagibig" amount_deduction="{{ $row->amount_deduction }}" remarks="{{ $row->remarks }}" date_to="{{ $row->date_to }}" date_from="{{ $row->date_from }}" pagibig_loan_id="{{ $row->pagibig_loan_id }}" employee="{{ $row->emp_name }}" pagibig_loan_date="{{ $row->pagibig_loan_date }}" loan_amount="{{ $row->loan_amount }}" data-toggle="modal" data-target="#update_pagibig_loan">
                           ...
                           <td class="text-center">
                              <div class="w-100">
                                 <a href="{{ url('/delete_pagibig_loan?id=').$row->pagibig_loan_id }}" onclick="return confirm('Delete Loan')" class="text-danger">
...
<div id="entry_modal" class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="myModalLabelAdd" style=" padding-right: 17px;">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <form class="form-material" action="{{ url('/add_pagibig_loan') }}" method="post">
            @csrf
                  ...
                  <div class="row p-t-20">
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="date" id="pagibig_loan_date" value="{{ date('Y-m-d') }}" name="pagibig_loan_date"  class="form-control" required>
                        </div>
                     </div>
                     <!--/span-->
                     <div class="col-md-6">
...
{{-- UPDATE MODAL --}}
<div id="update_pagibig_loan" class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="myModalLabelAdd" style=" padding-right: 17px;">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header bg-info text-white">
            <h4 class="modal-title">Update PAG-IBIG Loan</h4>
            <button type="button" class="close text-danger" data-dismiss="modal" aria-hidden="true" title="Close">×</button>
         </div>
         <form class="form-material" action="{{ url('/update_pagibig_loan') }}" method="post">
            @csrf
            <input type="hidden" id="pagibig_loan_id" name="pagibig_loan_id" required/>
            <div class="modal-body">
               <div class="form-body">
                  <div class="row p-t-20">
                     <div class="col-md-6">
                        <div class="form-group">
                           <label class="control-label">Date</label>
                           <input type="date" id="pagibig_loan_date_2" name="pagibig_loan_date"  class="form-control" readonly>
                        </div>
                     </div>
                     <!--/span-->
                     <div class="col-md-6">
...
<div id="view_deduction_pagibig_loan" class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="myModalLabelView" style=" padding-right: 17px;">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header bg-primary text-white">
...
{{-- add deduction MODAL --}}
<div id="add_deduction_pagibig_loan" class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="myModalLabelAdd" style=" padding-right: 17px;">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header bg-primary text-white">
         ...
         <form class="form-material" action="{{ url('/add_deduction_loan') }}" method="post">
            @csrf
            <input type="hidden" name="pagibig_loan_id" id="emp_pagibig_loan_id" />
            <input type="hidden" name="type" value="pagibig" />
            <div class="modal-body">
...
<script src="{{ asset('uidesign/js/custom/pagibig_loan.js') }}"></script>
@endsection
