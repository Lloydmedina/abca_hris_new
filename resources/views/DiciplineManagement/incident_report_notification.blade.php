         ...
         <div class="table-responsive m-t-40">
            <table id="example23" class="display nowrap table table-sm table-hover table-striped table-bordered" cellspacing="0" width="100%">
               ...
               <tbody id="list_body" name="list">
                  ...
                  <tr>
                     <td>{{ date('M d, Y', strtotime($row->date_prepared)) }}</td>
                     <td>{{ $row->emp_name }}</td>
                     <td>{{ $row->emp_mngr_name }}</td>
                  ...
                  <div class="row p-t-20">
                     ...
                     <div class="col-md-6">
                        <div class="form-group has-danger">
                           ...
                           <input type="date" id="date_prepared" name="date_prepared" value="{{ date('Y-m-d') }}" class="form-control" required>
                        </div>
                     </div>
                     <!--/span-->
                  </div>
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" id="contact_info" name="contact_info" value="{{ old('contact_info') }}" class="form-control" required>
                        </div>
                     </div>
                     <!--/span-->
                     <div class="col-md-6">
                              ...
                              <select id="dept_id" name="dept_id" class="form-control custom-select" required>
                                 @foreach($department as $row)
                                    @if(isset($_GET['dept_id']))
                                       @if($_GET['dept_id'] == $row->SysPK_Dept )
                                          <option value="{{ $row->SysPK_Dept }}" selected>{{ $row->Name_Dept }}</option>
                                       @else
...
<script src="{{ asset('uidesign/js/custom/incident_report_notification.js') }}"></script>
@endsection
