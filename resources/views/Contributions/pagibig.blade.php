...
@endsection
{{-- END PAGE LEVEL CSS --}}
@section('title','PAGIBIG Contributions')
{{-- BEGIN CONTENT --}}
@section('content')
<!-- Begin Page Content -->
<div class="container-fluid">
   ...
   <div class="card">
      <div class="card-body">
          <form action="{{ route('pagibig-contributions') }}" method="get">
              <div class="row">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    <h4 class="card-title">PAGIBIG Contributions</h4>
                </div>
            ...
            <div class="table-responsive m-t-40">
                <table id="pi_contri_table" class="display nowrap table table-sm table-hover table-striped table-bordered" cellspacing="0" width="100%">
                   <thead>
                      <tr>
